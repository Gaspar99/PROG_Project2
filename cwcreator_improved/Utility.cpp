...
// Characters are compared case-less.
//
// ADAPTED FROM:
// https://www.codeproject.com/Articles/188256/A-Simple-Wildcard-Matching-Function
bool Utility::wildcardMatch(const char *str, const char *strWild)
{
...
unsigned char Utility::to_upper(int ch)
{
    return static_cast<unsigned char>(toupper(ch));
}

unsigned char Utility::to_lower(int ch)
{
    return static_cast<unsigned char>(tolower(ch));
}

void Utility::capitalize(string &word)
{
...
void Utility::setcolor(unsigned int color)
{
    HANDLE hcon = GetStdHandle(STD_OUTPUT_HANDLE);
    SetConsoleTextAttribute(hcon, color);
}

void Utility::setcolor(unsigned int color, unsigned int background_color)
{
    HANDLE hCon = GetStdHandle(STD_OUTPUT_HANDLE);
...
#include <unistd.h>
  ...
  //==========================================================================================
  // Set text color
  void Utility::setcolor(string color)
  {
      cout << color;
  }
  //==========================================================================================
  // Set text color & background
  void Utility::setcolor(string color, string background_color)
  {
